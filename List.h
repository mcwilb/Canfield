...
public:
    ...
    //This function will use the iterator min function to return the
    //smallest number of the first list.
    int smallestNumber();

    //Function returns the element at a given postion input by user.
    void returnElementPosition(int elementNum);
  
    //Function to see if a number, entered by user, is found within first list.
    void locateANumber(int searchNum);
    ...
    //Simple display of the List with no other messages.
    void display();
}; // class List
